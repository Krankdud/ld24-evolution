package  
{
	...
	public class StarBackground extends Entity
	{
		...
		public function StarBackground() 
		{
			...
			_topleft = new Stamp(Resources.IMG_STARFIELD, 0, 0);
			_topmid = new Stamp(Resources.IMG_STARFIELD, 0, 0);
			_topright = new Stamp(Resources.IMG_STARFIELD, 0, 0);
			_bottomleft = new Stamp(Resources.IMG_STARFIELD, 0, 0);
			_bottommid = new Stamp(Resources.IMG_STARFIELD, 0, 0);
			_bottomright = new Stamp(Resources.IMG_STARFIELD, 0, 0);
